...
//    private static final String TAG = "XListView";
    ...
    /**
     * Auto call back refreshBannerView.
     */
    public void autoRefresh() {
        mHeader.setVisibleHeight(DensityUtil.dip2px(getContext(), 60));
        updateHeaderHeight(DensityUtil.dip2px(getContext(), 60));
//        invokeOnScrolling();
    ...
    public void onScrollStateChanged(AbsListView view, int scrollState) {
        ...
        if(myScrollListener != null){
            myScrollListener.onScrollStateChanged(view,scrollState);
        }
    }
    ...
    public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount,
        ...
        if(myScrollListener != null){
            myScrollListener.onScroll(view,firstVisibleItem,visibleItemCount,totalItemCount);
        }
    }
    ...
    /**
     * Implements this interface to get refreshBannerView/load more event.
     *
     * @author markmjw
     */
    ...
    //用于自定义滑动监听，因为外部设置会替换掉XlistView内部的监听，所以需要自定义
